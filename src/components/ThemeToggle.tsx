...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="border-border text-text-muted hover:text-text-primary hover:border-accent flex h-7 w-7 cursor-pointer items-center justify-center rounded-md border transition-colors"
    >
